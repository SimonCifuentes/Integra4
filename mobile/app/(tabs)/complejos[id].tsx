...
export default function ComplejosScreen() {
  // ✅ misma llamada funcional que usas en canchas
  const { data, isLoading, isError, refetch, isRefetching } = useComplejos({ page: 1, page_size: 20 });
  ...
  // Opciones rápidas (si tu API trae catálogos, reemplaza estas listas)
  const deportes = ["Fútbol", "Pádel", "Tenis", "Básquetbol"];
  const sectores = ["Centro", "Ñielol", "Labranza"];

  // Normaliza items desde el backend: acepta paginado o lista plana
