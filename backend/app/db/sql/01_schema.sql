...
CREATE INDEX IF NOT EXISTS idx_bloqueos_rango  ON bloqueos USING GIST (tsrange(date_trunc('minute', inicio::timestamptz), date_trunc('minute', fin::timestamptz), '[]'));
...
CREATE INDEX IF NOT EXISTS idx_refresh_user ON refresh_tokens(id_usuario);
