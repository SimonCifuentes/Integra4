...
-- -------------------------------------------------------------
WITH su AS (
  INSERT INTO usuarios (nombre, apellido, email, hashed_password, rol, verificado)
  VALUES (
...
SELECT id_cancha, NULL, '08:00', '18:00', 10000 FROM c
UNION ALL
SELECT id_cancha, NULL, '18:00', '23:00', 12000 FROM c
ON CONFLICT DO NOTHING;
